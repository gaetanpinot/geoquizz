 ...
 */
final class Version20250207142308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partie (id SERIAL NOT NULL, id_serie INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, id_joueur UUID DEFAULT NULL, status INT NOT NULL, difficulte INT NOT NULL, nb_coups_total INT NOT NULL, score INT NOT NULL, PRIMARY KEY(id))');
