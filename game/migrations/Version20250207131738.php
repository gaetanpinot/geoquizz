 ...
 */
final class Version20250207131738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partie (id SERIAL NOT NULL, id_serie INT NOT NULL, id_joueur UUID DEFAULT NULL, status INT NOT NULL, difficulte INT NOT NULL, nb_coups_total INT NOT NULL, score INT NOT NULL, PRIMARY KEY(id))');
