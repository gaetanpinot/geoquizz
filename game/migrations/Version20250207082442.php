 ...
 */
final class Version20250207082442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partie (id SERIAL NOT NULL, id_serie INT NOT NULL, id_joueur UUID NOT NULL, status INT NOT NULL, difficulte INT NOT NULL, nb_coups_total INT DEFAULT NULL, score INT NOT NULL, PRIMARY KEY(id))');
